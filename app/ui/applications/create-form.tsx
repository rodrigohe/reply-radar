...
export default function CreateForm({ defaultLocations }: { defaultLocations: LocationColors[] }) {
    ...
    <form action={formAction}>
      ...
      <div className="md:flex md:flex-row md:gap-5">
        ...
        <div className="mb-5 md:w-3/4 md:flex-grow">
          ...
          <div>
            <LocationComboBox defaultSelected={null} defaultLocations={defaultLocations} />
          </div>
