...
import { Application, LocationColors, Stages } from "@/app/lib/definitions";
      ...
      <fieldset disabled={readOnly}>
        ...
        <div className="md:flex md:flex-row md:gap-5">
          ...
          <div className="mb-5 md:w-3/4 md:flex-grow">
            ...
            <div>
              <LocationComboBox defaultSelected={data.location_colors} readOnly={readOnly} defaultLocations={defaultLocations}/>
            </div>
